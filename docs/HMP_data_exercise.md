...
#### Run Metaviz to compare the two abundance matrices
...
Before you can proceed to the visualization you will need to exit from the hmp_client_interactive Docker image and launch the Metaviz Docker image by using the following commands.
